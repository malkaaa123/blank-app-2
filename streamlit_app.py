...
with tab1:
    if base_2023 is not None and base_2024 is not None:
        ...
        if gerencias_selecionadas and afirmativas_selecionadas and anos_selecionados:
            ...
            # Cálculo das maiores quedas entre 2023 e 2024
            ...
            # Obter as 5 maiores quedas e seus detalhes
            maiores_quedas = deltas_mean.head(5)
            maiores_quedas_detalhes = pd.DataFrame({
                "Afirmativa": maiores_quedas.index,
                "Queda (Diferença)": maiores_quedas.values,
                "Resultado 2023": base_2023_filtrada.set_index(base_2023_filtrada.columns[0]).mean(),
                "Resultado 2024": base_2024_filtrada.set_index(base_2024_filtrada.columns[0]).mean()
            })
