...
maiores_quedas_detalhes = pd.DataFrame({
    ...
    "Resultado 2023": base_2023_filtrada.set_index(base_2023_filtrada.columns[0])[maiores_quedas].mean(),
    "Resultado 2024": base_2024_filtrada.set_index(base_2024_filtrada.columns[0])[maiores_quedas].mean()
})
